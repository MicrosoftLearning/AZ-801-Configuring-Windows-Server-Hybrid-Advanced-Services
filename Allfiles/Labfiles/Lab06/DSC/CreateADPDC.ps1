...
{ 
    ...
    $InterfaceAlias = (Get-NetIPConfiguration | Where-Object { $_.IPv4DefaultGateway -and $_.IPv4Address } | Select-Object -First 1).InterfaceAlias
    $DataDiskNumber = (Get-Disk | Where-Object PartitionStyle -EQ 'RAW' | Sort-Object Number | Select-Object -First 1).Number
